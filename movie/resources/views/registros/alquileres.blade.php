...
<div class="container mt-3 p-3 bg-white" >
   ...
   <!--Muestra todos los registro de las peliculas-alquiler en una table-->
    <table id="peliculas" class="table table-dark table-striped mt-4" >
        <thead>
            ...
            <tbody>
                <!-- con un foreach mostramos todo lo registro de la tabla alquileres-->
                ...
                <tr>
                    ...
                    <td>{{$alquiler->precio_al}}</td>
                    <td>{{$alquiler->fecha_i}}</td>
                    <td>{{$alquiler->fecha_f}}</td>
                    <td>{{$alquiler->fecha_e}}</td>
                    <td>{{$alquiler->multa}}</td>
                    <td>{{$alquiler->monto_multa}}</td>
