...
<div class="container bg-white p-2 mt-3" style="width: 50%;" >
    <h2>Editar peliculas</h2>
    <form action="../{{$pelicula->id}}" enctype="multipart/form-data" method="POST" >
        @csrf
        @method('PUT')
        <div class="mb-3">
            <label for="" class="form-label">titulo</label>
            <input id="titulo" name="titulo" type="text" class="form-control" value="{{$pelicula->titulo}}" oninput="validacion.multi()">
        </div>
        <div class="alert alert-danger mb-2"  style="display:none" role="alert" id="mensaje1">
            Rellena el campo 
        </div>
        <div class="mb-3">
            <label for="" class="form-label">descripcion</label>
            <textarea  id="descripcion" name="descripcion" type="text" class="form-control"  rows="3" oninput="validacion.multi()">{{$pelicula->descripcion}}</textarea>
           
        </div>
        <div class="alert alert-danger mb-2"  style="display:none" role="alert" id="mensaje2">
            Rellena el campo 
        </div>
        ...
        <div class="mb-3">
            ...
            <input id="stock" name="stock" type="number" class="form-control" value="{{$pelicula->stock}}" oninput="validacion.multi()">
        </div>
        <div class="alert alert-danger mb-2"  style="display:none" role="alert" id="mensaje3">
            Rellena el campo 
        </div>

        <div class="mb-3">
            <label for="" class="form-label">Precio de alquiler</label>
            <input id="precio_al" name="precio_al" type="number" step="0.001" class="form-control" value="{{$pelicula->precio_al}}" oninput="validacion.multi()">
        </div>
        <div class="alert alert-danger mb-2"  style="display:none" role="alert" id="mensaje4">
            Rellena el campo 
        </div>

        <div class="mb-3">
            <label for="" class="form-label">Precio de compra</label>
            <input id="precio_com" name="precio_com" type="number" step="0.001" class="form-control" value="{{$pelicula->precio_com}}" oninput="validacion.multi()">
        </div>
        <div class="alert alert-danger mb-2"  style="display:none" role="alert" id="mensaje5">
            Rellena el campo 
        </div>
        <div class="mb-3">
        ...
        <button id="guardar" type="submit" class="btn btm-primary" tabindex="9">Guardar</button>
