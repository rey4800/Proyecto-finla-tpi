...
@section('contenidoPrincipal')
                ...
                <div class="video">
                    <video autoplay width="100%" height="50px" muted >
                        <source src="{{ asset('videos/Arcane.mp4')}}" type='video/mp4'>
                    </video>
                </div>
            ...
            <div class="glider-contain" style="display: none">
                ...
                <div class="glider glider0">
                    @foreach($peliculas as $pelicula)
                      @if($pelicula->id > '0' && $pelicula->id < '15' && $pelicula->disponivilidad == 'si' )
                        
                        <div class="text-center" style="width: 250px;heigth:300px" >
                        <img style="height: 200px; width:100%" src="{{$pelicula->imagen}}">
            ...
            <div class="glider-contain" style="display: none">
                ...
                <div class="glider glider1">
                    @foreach($peliculas as $pelicula)
                      @if($pelicula->id > '16' && $pelicula->id < '30' && $pelicula->disponivilidad == 'si' )
                      
                      <div class="text-center" style="width: 250px;heigth:300px" ><img style="height: 200px; width:100%" src="{{$pelicula->imagen}}"><a class="text-white" href="#">Ver mas</a></div>
                      @endif
                    @endforeach    
                    ...
                    <div class="col-6">
                        <div style="width: 100%;">
                            <video  controls width="100%" height="50px" >
                                <source src="{{ asset('videos/Spiderman.mp4')}}" type='video/mp4'>
                            </video>
                        </div>
                    </div>
